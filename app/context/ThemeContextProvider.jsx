...
const ThemeContextProvider = ({ children }) => {
  ...
  const themeStyles = {
    dark: {
      ...
      card: "bg-[#0e152b]/80 border-1 border-[#f7922c] shadow-[0_0_10px_rgba(255,107,53,0.25)] hover:shadow-[inset_0_0_15px_rgba(255,107,53,0.1)] backdrop-blur-sm", //(border orange aye ga) (and card ka bg dark blue ka koi shade aye ga)
      headings:
