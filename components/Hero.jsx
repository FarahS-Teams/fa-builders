...
const Hero = ({
  ...
  return (
    ...
    >
      ...
      {/* Decorative Lines */}
      <div className="absolute bottom-0 left-0 w-full h-0.5 bg-linear-to-r from-secondary to-transparent" />
      <div className="absolute top-1 left-0 w-full h-px bg-linear-to-r from-secondary to-transparent" />
    </section>
  );
};
